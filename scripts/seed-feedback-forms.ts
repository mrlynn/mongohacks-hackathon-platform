    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "long_text" as const,
          label: 'If you answered "Yes", please describe your use case',
          description: "",
          required: false,
          placeholder: "",
          options: [],
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          id: "nps-partner",
          type: "linear_scale" as const,
          label: "How likely are you to partner with us for future events?",
          description: "",
          required: true,
          placeholder: "",
          options: [],
        ...
        },
        {
          id: "improvements",
          type: "long_text" as const,
          label: "What could we do to improve the partner experience?",
          description: "",
          required: false,
          placeholder: "",
          options: [],
...
async function seedFeedbackForms() {
  ...
  for (const formData of [
    ...
    const result = await FeedbackFormConfigModel.findOneAndUpdate(
      { slug: formData.slug },
      { $set: formData },
      { upsert: true, new: true }
    );
    console.log(`  Seeded: ${formData.name} (${result._id})`);
  }

  console.log("\nFeedback forms seeded successfully!");
}

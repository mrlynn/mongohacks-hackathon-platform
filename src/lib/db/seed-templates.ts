...
const defaultSections = [
  ...
  { type: "sponsors" as const, enabled: true, layout: "grid", style: { bgStyle: "light" as const, spacing: "default" as const } },
...
export const builtInTemplates = [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "sponsors" as const, enabled: true, layout: "grid", style: { bgStyle: "light" as const, spacing: "spacious" as const } },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "sponsors" as const, enabled: true, layout: "grid", style: { bgStyle: "dark" as const, spacing: "default" as const } },
...
/**
 * Seed built-in template configs. Idempotent — only inserts missing templates by slug.
 */
